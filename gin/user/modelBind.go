...
func (modelBind *ModelBind) BindHandler(c *gin.Context) {
	...
	if err := c.Bind(&user); err == nil {
		log.Printf("c.Bind() user.Name=%v user.Age=%v user.Address=%v", Name, Age, Address)
	} else {
...
func (modelBind *ModelBind) BindJSONHandler(c *gin.Context) {
	...
	if err := c.BindJSON(&user); err == nil {
		log.Printf("c.BindJSON() user.Name=%v user.Age=%v user.Address=%v", Name, Age, Address)
	} else {
...
func (modelBind *ModelBind) ShouldBindHandler(c *gin.Context) {
	...
	if err := c.ShouldBind(&user); err == nil {
		log.Printf("c.ShouldBind() user.Name=%v user.Age=%v user.Address=%v", Name, Age, Address)
	} else {
...
func (modelBind *ModelBind) ShouldBindJSONHandler(c *gin.Context) {
	...
	if err := c.ShouldBindJSON(&user); err == nil {
		log.Printf("c.ShouldBindJSON() user.Name=%v user.Age=%v user.Address=%v", Name, Age, Address)
	} else {
